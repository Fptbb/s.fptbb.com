        ...
        <html>
            ...
            <body class="ph3 pb3 mid-gray">
                <header class="mw8 pv4 center">
                    ...
                    <p>
                        Isso é o mapa do site, utilizado normalmente pelos sites de busca.<br/>
                        Voce pode encontrar informações sobre esse tipo de sistema <a href="https://sitemaps.org" class="link blue">aqui</a>.
                    </p>
                </header>
                ...
                <footer class="mw8 center pv4 tc">
                    Por <a href="https://robr.page/fptbb" title="Fptbb" class="link blue">Fptbb</a>
                </footer>
